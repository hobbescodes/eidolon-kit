...
export const NumberInput = forwardRef<HTMLDivElement, NumberInputProps>(
  (props, ref) => {
    const { children, size, className, placeholder, ...rootProps } = props;
    ...
    return (
      ...
      >
        {children && (
          <ArkNumberInput.Label className={label()}>
            {children}
          </ArkNumberInput.Label>
        )}
        <ArkNumberInput.Control className={control()}>
          <ArkNumberInput.Input className={input()} placeholder={placeholder} />
