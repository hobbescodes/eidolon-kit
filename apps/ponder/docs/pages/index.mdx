# Getting Started [Understand the core concepts and features of the ponder application.]

The intention of the ponder application is to provide a rapid development environment for APIs. It is built on top of [Ponder](https://ponder.sh/), a framework for building APIs on top of any EVM smart contract.
